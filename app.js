...
let platepizza=document.querySelector("#platepizza");
platepizza.addEventListener("click", async (evt) => {
...
let plateburger=document.querySelector("#plateburger");
plateburger.addEventListener("click", async (evt) => {
...
plate.addEventListener("click", async (evt) => {
